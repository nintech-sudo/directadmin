...
$VERSION = '.9.4';
$ROOT_PATH = '/home/admin/admin_backups/';
...
sub main {
	...
	print "This tool will convert file backups created by script \033[31m/scripts/pkgacct username\033[0m in cPanel\n";
	print "After running this tool, the converted file will be exported at \033[31m\033[31m${ROOT_PATH}file_backup/\033[0m directory.\n";
	print "\n";
	...
	print "All tarballs residing in \033[31m${ROOT_PATH}import/\033[0m will be checked for validity and converted to the DirectAdmin format.\n";
	print "DirectAdmin formatted tarballs will be placed in \033[31m${ROOT_PATH}file_backup/\033[0m.\n";
	print "\n";
